...
from app.services.supervised_opencv_processor import is_supervised_render_plan
...
class ManualEditService:
    ...
    def _build_context(
        ...
        *,
        ...
        source_is_supervised = is_supervised_render_plan(source_plan)
        source_is_visual_anchor = source_is_style or source_is_supervised
        ...
        raw_region = (
            None if source_is_visual_anchor else source_parameters.get("region")
        ) or (
        ...
        raw_mask_type = (
            None if source_is_visual_anchor else source_parameters.get("mask_type")
        ) or (
