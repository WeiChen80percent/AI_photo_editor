...
abstract class AppLocalizations {
  ...
  /// No description provided for @mobileActions.
  ///
  /// In en, this message translates to:
  /// **'More actions'**
  String get mobileActions;

  /// No description provided for @mobileSave.
  ///
  /// In en, this message translates to:
  /// **'Save selected version to Photos'**
  String get mobileSave;

  /// No description provided for @mobileRestore.
  ///
  /// In en, this message translates to:
  /// **'Restore recent work'**
  String get mobileRestore;

  /// No description provided for @mobileConnection.
  ///
  /// In en, this message translates to:
  /// **'Server connection'**
  String get mobileConnection;
  ...
  /// No description provided for @mobileSaveSettings.
  ///
  /// In en, this message translates to:
  /// **'Save address'**
  String get mobileSaveSettings;

  /// No description provided for @mobileServerAddress.
  ///
  /// In en, this message translates to:
  /// **'Server address'**
  String get mobileServerAddress;

  /// No description provided for @mobileCheckConnection.
  ///
  /// In en, this message translates to:
  /// **'Check connection'**
  String get mobileCheckConnection;

  /// No description provided for @mobileConnectionHelp.
  ///
  /// In en, this message translates to:
  /// **'Connect your phone and computer to the same Wi-Fi. Enter the computer\'s address. Android Emulator can use http://10.0.2.2:8000. 127.0.0.1 refers to this device. Photos and audio are sent to this server for processing.'**
  String get mobileConnectionHelp;

  /// No description provided for @mobileConnectionOk.
  ///
  /// In en, this message translates to:
  /// **'Connected. Model availability is checked when you use each tool.'**
  String get mobileConnectionOk;

  /// No description provided for @mobileUrlInvalid.
  ///
  /// In en, this message translates to:
  /// **'Enter a complete HTTP(S) address without login information, query or fragment.'**
  String get mobileUrlInvalid;

  /// No description provided for @mobileNetworkFailed.
  ///
  /// In en, this message translates to:
  /// **'Cannot reach the server. Check the address, Wi-Fi and whether the backend is running.'**
  String get mobileNetworkFailed;

  /// No description provided for @mobileTimeout.
  ///
  /// In en, this message translates to:
  /// **'The operation timed out. The server may still complete it; refresh History before retrying.'**
  String get mobileTimeout;

  /// No description provided for @mobileOperationFailed.
  ///
  /// In en, this message translates to:
  /// **'The operation failed. Please try again and check system permissions.'**
  String get mobileOperationFailed;

  /// No description provided for @mobileImageTooLarge.
  ///
  /// In en, this message translates to:
  /// **'Images must be 40 MB or smaller. Choose a smaller JPEG or PNG.'**
  String get mobileImageTooLarge;

  /// No description provided for @mobileImageDimensions.
  ///
  /// In en, this message translates to:
  /// **'Mobile images must be 24 megapixels or smaller. No automatic resizing was performed.'**
  String get mobileImageDimensions;

  /// No description provided for @mobileImageFormat.
  ///
  /// In en, this message translates to:
  /// **'Choose a JPEG/JPG or PNG image. HEIC, RAW and other formats are not supported.'**
  String get mobileImageFormat;

  /// No description provided for @mobileImageInvalid.
  ///
  /// In en, this message translates to:
  /// **'This image could not be read. Try another JPEG or PNG.'**
  String get mobileImageInvalid;

  /// No description provided for @mobileImageSize.
  ///
  /// In en, this message translates to:
  /// **'Image: {width} × {height} pixels'**
  String mobileImageSize(int width, int height);

  /// No description provided for @mobileSaved.
  ///
  /// In en, this message translates to:
  /// **'Saved to Photos: {width} × {height} pixels. No additional compression.'**
  String mobileSaved(int width, int height);

  /// No description provided for @mobileGalleryDenied.
  ///
  /// In en, this message translates to:
  /// **'Photo access was denied. Enable it in system settings and try again.'**
  String get mobileGalleryDenied;

  /// No description provided for @mobileGalleryFull.
  ///
  /// In en, this message translates to:
  /// **'Not enough storage space to save this image.'**
  String get mobileGalleryFull;

  /// No description provided for @mobileGalleryFailed.
  ///
  /// In en, this message translates to:
  /// **'Could not save to Photos. Check permissions and available storage.'**
  String get mobileGalleryFailed;

  /// No description provided for @mobileApplyBeforeSave.
  ///
  /// In en, this message translates to:
  /// **'Apply or discard the preview before saving a version.'**
  String get mobileApplyBeforeSave;

  /// No description provided for @mobilePersistenceFailed.
  ///
  /// In en, this message translates to:
  /// **'Local settings could not be saved. Recent work may not restore after restarting.'**
  String get mobilePersistenceFailed;

  /// No description provided for @mobileRestoreRetry.
  ///
  /// In en, this message translates to:
  /// **'Recent work could not be restored. Check the server, then choose Restore recent work from More actions.'**
  String get mobileRestoreRetry;

  /// No description provided for @mobileSessionMissing.
  ///
  /// In en, this message translates to:
  /// **'The server no longer has this session. Choose a new original to start again.'**
  String get mobileSessionMissing;

  /// No description provided for @mobileRestoreConfirm.
  ///
  /// In en, this message translates to:
  /// **'Restore the last saved session? Current unsubmitted photos and drafts will be discarded after restoration succeeds.'**
  String get mobileRestoreConfirm;

  /// No description provided for @mobileServerChangeConfirm.
  ///
  /// In en, this message translates to:
  /// **'Changing servers opens a new workspace. Current drafts will be discarded. Committed versions remain on the previous server.'**
  String get mobileServerChangeConfirm;

  /// No description provided for @mobilePickerRecoveryFailed.
  ///
  /// In en, this message translates to:
  /// **'The interrupted photo selection could not be recovered. Please select the image again.'**
  String get mobilePickerRecoveryFailed;

  /// No description provided for @mobileReferenceRecoveryFailed.
  ///
  /// In en, this message translates to:
  /// **'The original was not saved before interruption. Select the original and reference again.'**
  String get mobileReferenceRecoveryFailed;

  /// No description provided for @mobileWaitForOperation.
  ///
  /// In en, this message translates to:
  /// **'Please wait for the current operation to finish, or use its Cancel action.'**
  String get mobileWaitForOperation;

  /// No description provided for @mobileExitConfirm.
  ///
  /// In en, this message translates to:
  /// **'Discard the unfinished preview and leave? Committed versions remain on the server.'**
  String get mobileExitConfirm;
}
