...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get mobileActions => '更多操作';

  @override
  String get mobileSave => '將選定版本儲存到相簿';

  @override
  String get mobileRestore => '恢復最近工作';

  @override
  String get mobileConnection => '後端連線設定';

  @override
  String get mobileContinue => '繼續';

  @override
  String get mobileSaveSettings => '儲存位址';

  @override
  String get mobileServerAddress => '後端位址';

  @override
  String get mobileCheckConnection => '檢查連線';

  @override
  String get mobileConnectionHelp =>
      '手機與電腦請連同一個 Wi-Fi，並輸入電腦的位址。Android 模擬器可用 http://10.0.2.2:8000；127.0.0.1 指的是目前裝置。照片與語音會傳到此後端處理。';

  @override
  String get mobileConnectionOk => '後端已連線。各模型是否可用會在使用工具時確認。';

  @override
  String get mobileUrlInvalid => '請輸入完整的 HTTP(S) 位址，不含帳密、查詢參數或片段。';

  @override
  String get mobileNetworkFailed => '無法連到後端，請確認位址、Wi-Fi 與後端是否正在執行。';

  @override
  String get mobileTimeout => '操作等待逾時，後端可能仍在處理；請先同步歷史紀錄再重試。';

  @override
  String get mobileOperationFailed => '操作失敗，請稍後重試並確認系統權限。';

  @override
  String get mobileImageTooLarge => '圖片需小於或等於 40 MB，請選較小的 JPEG 或 PNG。';

  @override
  String get mobileImageDimensions => '手機版圖片需小於或等於 2,400 萬像素，本次未自動縮圖。';

  @override
  String get mobileImageFormat => '請選 JPEG／JPG 或 PNG 圖片；不支援 HEIC、RAW 或其他格式。';

  @override
  String get mobileImageInvalid => '無法讀取這張圖片，請改選其他 JPEG 或 PNG。';

  @override
  String mobileImageSize(int width, int height) {
    return '圖片：$width × $height 像素';
  }

  @override
  String mobileSaved(int width, int height) {
    return '已儲存至相簿：$width × $height 像素，未額外壓縮。';
  }

  @override
  String get mobileGalleryDenied => '相簿存取未獲允許，請在系統設定開啟權限後重試。';

  @override
  String get mobileGalleryFull => '裝置儲存空間不足，無法儲存圖片。';

  @override
  String get mobileGalleryFailed => '無法儲存至相簿，請確認權限與剩餘空間。';

  @override
  String get mobileApplyBeforeSave => '請先套用或捨棄預覽，再儲存正式版本。';

  @override
  String get mobilePersistenceFailed => '無法儲存本機設定，重新開啟後可能無法恢復最近工作。';

  @override
  String get mobileRestoreRetry => '最近工作尚未恢復。請確認後端連線，再從「更多操作」選擇「恢復最近工作」。';

  @override
  String get mobileSessionMissing => '後端已找不到此工作階段，請選擇新原圖重新開始。';

  @override
  String get mobileRestoreConfirm => '要恢復最近工作嗎？恢復成功後，會捨棄目前尚未提交的照片與草稿。';

  @override
  String get mobileServerChangeConfirm => '切換後端會開啟另一個工作區並捨棄目前草稿，已提交版本仍留在原後端。';

  @override
  String get mobilePickerRecoveryFailed => '無法恢復中斷的選圖，請重新選擇圖片。';

  @override
  String get mobileReferenceRecoveryFailed => '中斷前尚未保存原圖，請重新選擇原圖與參考圖。';

  @override
  String get mobileWaitForOperation => '請等待目前操作完成，或使用該工具的取消操作。';

  @override
  String get mobileExitConfirm => '要捨棄尚未完成的預覽並離開嗎？已提交版本仍保存在後端。';
}
